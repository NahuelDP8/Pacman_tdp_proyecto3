...
public class Goku extends Protagonista{
	private ImageIcon imgDerecha=new ImageIcon(Goku.class.getResource("/Imagenes/goku.gif"));
	private ImageIcon imgIzquierda=new ImageIcon(Goku.class.getResource("/Imagenes/gokuIzquierda.gif"));
