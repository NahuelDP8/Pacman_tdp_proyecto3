...
public class Naruto extends Protagonista{
	...
	private ImageIcon imgDerechaBomba=new ImageIcon(Naruto.class.getResource("/Imagenes/narutoRun.gif"));
	private ImageIcon imgIzquierdaBomba=new ImageIcon(Naruto.class.getResource("/Imagenes/narutoRunIzquierda.gif"));
	private ImageIcon imgDerechaVelocidad=new ImageIcon(Naruto.class.getResource("/Imagenes/madaraRun.gif"));
	private ImageIcon imgIzquierdaVelocidad=new ImageIcon(Naruto.class.getResource("/Imagenes/madaraRunIzquierda.gif"));
