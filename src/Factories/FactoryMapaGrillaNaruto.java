...
public class FactoryMapaGrillaNaruto extends FactoryMapaGrilla{
	...
	public MapaGrilla crearMapa1(Logica logica) {
		FactoryProtagonista fabricaProt = new FactoryNaruto(); 
		FactoryEnemigo fabricaEnem = new FactoryNinjaMalvado(); 
		
		MapaGrilla mapa = new Mapa1(miImagen1,fabricaProt,fabricaEnem, 0, 0,logica);
		
		return mapa;
	}
	public MapaGrilla crearMapa2(Logica logica) {
		FactoryProtagonista fabricaProt = new FactoryNaruto(); 
		FactoryEnemigo fabricaEnem = new FactoryNinjaMalvado(); 
		
		MapaGrilla mapa = new Mapa2(miImagen2,fabricaProt,fabricaEnem, 0, 0,logica);
		
		return mapa;
	}
	public MapaGrilla crearMapa3(Logica logica) {
		FactoryProtagonista fabricaProt = new FactoryNaruto(); 
		FactoryEnemigo fabricaEnem = new FactoryNinjaMalvado(); 
		
		MapaGrilla mapa = new Mapa3(miImagen3,fabricaProt,fabricaEnem, 0, 0,logica);
